...
%   literate={`}{\textasciigrave}1 {`}{\textquotesingle}1,
%   % ... (other options)
% }
\usepackage[tmargin=2cm,rmargin=1in,lmargin=1in,margin=0.85in,bmargin=2cm,footskip=.2in]{geometry}
\usepackage{amsmath,amsfonts,amsthm,amssymb,mathtools}
% \usepackage[varbb]{newpxmath, newpxtext}
\usepackage{xfrac}
\usepackage{float}
\usepackage{tabularx}
\usepackage{booktabs}
...
{\begin{center}\textcolor{blue}{\textbf{\large #1}}\end{center}\vspace{2mm}}
{\vspace{2mm}}
...
% % Modify the chapter title format for the ToC
% \renewcommand{\cftchappresnum}{\bfseries\chaptername\ }
% \renewcommand{\cftchapaftersnum}{:}
% \renewcommand{\cftchapnumwidth}{5em}
%
% % Modify the section and subsection formats for the ToC
% \renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
% \renewcommand{\cftsubsecleader}{\cftdotfill{\cftdotsep}}
%
% % Remove the bold from chapter entries
